...
更新时间：2021-6-9
修改时间：2021-6-17 去除内置助力码；禁止助力码下发
活动入口：京喜APP-我的-京喜财富岛
...
/*   let res = {}, res2 = await getAuthorShareCode("https://raw.githubusercontent.com/gitupdate/updateTeam/master/shareCodes/cfd.json")
  ...
  let res = {}, res2 = await getAuthorShareCode("https://127.0.0.1/cfd.json")
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('http://127.0.0.1/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://127.0.0.1/cfd.json')
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    $.newShareCodes = ["C0986D5D256880A7BA7C6DE3E284B2E27B14A30068AD70206A8376C11AF97917","49F59F1E14E35B03F740925A00B3D0EC3C8A4E1CCE43462790C7DAC16034B0DC","346ABDC773FBFE44B2F7F657CFE91F19DA39C6B6D9049A521D740DF124AD2A9C","F795B1EF7069E8582C05E3164CD9F87B7BC9410F88E499EB80409D3A8E840E36","7282FB0F39B40CCF86EBD6E9318101A09F3E4F1E67061972B1C2BCECA40269CC","A0EEBFB9657A7480D61C1A9B4164C4007C2B8CCE43E1A4D97F06BA99171FE178"];
    if ($.shareCodesArr[$.index - 1]) {
      $.newShareCodes = $.shareCodesArr[$.index - 1].split('@');
    } else {
      console.log(`由于您第${$.index}个京东账号未提供shareCode,将采纳本脚本自带的助力码\n`)
      // const tempIndex = $.index > inviteCodes.length ? (inviteCodes.length - 1) : ($.index - 1);
      // $.newShareCodes = [...$.strMyShareIds, "853A8ABB3A7EFEB36C806F6015F03587633CC1A56A40F04DF24A4102C86C9E07","228B426206DCA0D59547720566AAAB3901A33DA1256F943174774CF53CAC8C86","346ABDC773FBFE44B2F7F657CFE91F1965390B021798E427F378915416373863","F795B1EF7069E8582C05E3164CD9F87BB1FC4C79F7B2FEA3A944600A80460FD1","7282FB0F39B40CCF86EBD6E9318101A0020E27BFAD364E39249F465666CBA3E8","A0EEBFB9657A7480D61C1A9B4164C4005C3620F8DDF2549C03BB1677B5CE86C4"];
      $.newShareCodes = [];
	  }
